...
# Conectamos la base de datos RDS "jaddb"
...
# Acceso a S3 con 'C:\Users\javia\.aws\credentials'
# Leemos el archivo CSV que se añade al bucket "jad-football-results" de S3
